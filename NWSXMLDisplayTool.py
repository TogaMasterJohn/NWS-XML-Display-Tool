...
NWS XML Display Tool, version 0.9.1
...
def displayValues():
    ...
    #make the labels
    obsCurrentConditionsLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsLocationLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsStationIdLatLonLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsObservationTimeLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsWeatherLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsTemperatureLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsDewpointLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsRelativeHumidityLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsWindStringLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsVisibilityLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))
    obsPressureLabel = tk.Label(text = "", bg = "#AFDEF7", font = ("Arial, 21"))

    #destroy the labels if necessary; this is necessary if another XML file is opened
    global filesOpened
    if filesOpened > 0:
        obsCurrentConditionsLabel.destroy()
        obsLocationLabel.destroy()
        obsStationIdLatLonLabel.destroy()
        obsObservationTimeLabel.destroy()
        obsWeatherLabel.destroy()
        obsTemperatureLabel.destroy()
        obsDewpointLabel.destroy()
        obsRelativeHumidityLabel.destroy()
        obsWindStringLabel.destroy()
        obsVisibilityLabel.destroy()
        obsPressureLabel.destroy()
